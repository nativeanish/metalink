    ...
    <div className="bg-white border-4 border-gray-800 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-4 sm:p-6 mb-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2 w-full">
          <button
            className="flex-1 min-w-[120px] px-4 py-2 border-2 border-gray-800 bg-white hover:bg-gray-100 flex items-center justify-center"
          ...
          <button
            ...
            className="flex-1 min-w-[120px] px-4 py-2 border-2 border-gray-800 bg-white text-yellow-800 hover:bg-gray-100 flex items-center justify-center"
          >
            <FaEdit className="w-4 h-4 mr-2" /> Edit
          </button>
          <button
            onClick={() => onDelete(selectedLink.id)}
            className="flex-1 min-w-[120px] px-4 py-2 border-2 border-gray-800 bg-white hover:bg-gray-100 flex items-center justify-center text-red-600 hover:text-red-800"
          >
            <FaTrash className="w-4 h-4 mr-2" /> Delete
          </button>
          <button
            onClick={() => reload(true)}
            className="flex-1 min-w-[120px] px-4 py-2 border-2 border-gray-800 bg-white hover:bg-gray-100 flex items-center justify-center text-gray-700 hover:text-gray-900"
          >
          ...
          <button
            ...
            className="flex-1 min-w-[120px] px-4 py-2 border-2 border-gray-800 bg-white hover:bg-gray-100 flex items-center justify-center text-blue-600 hover:text-blue-800"
          >
